...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-blink-diff/node_modules/blink-diff/lib/compatibility.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-blink-diff/node_modules/blink-diff/lib/compatibility.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-blink-diff/node_modules/blink-diff/lib/</a> &#187; compatibility.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >			options.blockOut = options.blockOut || [];</span>
<span class="cstat-no" title="statement not covered" >			if (typeof options.blockOut != 'object' &amp;&amp; (options.blockOut.length !== undefined)) {</span>
<span class="cstat-no" title="statement not covered" >				options.blockOut = [options.blockOut];</span>
			}
&nbsp;
<span class="cstat-no" title="statement not covered" >			blockOuts = [];</span>
<span class="cstat-no" title="statement not covered" >			options.blockOut.forEach(<span class="fstat-no" title="function not covered" >function (blockOut) {</span></span>
<span class="cstat-no" title="statement not covered" >				blockOuts.push({</span>
					visible: true,
					area: {
						left: blockOut.x,
						top: blockout.y,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >			if (options.cropImageA) {</span>
<span class="cstat-no" title="statement not covered" >				config.imageA.crop = {</span>
...
<span class="cstat-no" title="statement not covered" >			if (options.cropImageB) {</span>
<span class="cstat-no" title="statement not covered" >				config.imageB.crop = {</span>
